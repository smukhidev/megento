...
class Shurjopay extends AbstractMethod
{
    ...
    protected $_gateUrl = "https://shurjopay.com/sp-data.php";
    
    protected $_testUrl = "https://shurjotest.com/sp-data.php";
    ...
    public function sp_hash_key($store_passwd="", $post_data=array()) 
    {
    ...
    public function responseAction($response)
    {
        ...
        if($this->_request->getPost()) 
        {
        	if($this->sp_hash_key($pass, $this->_request->getPost()))
        	{
